...
@Component({
  selector: 'app-medicall-record-add',
  templateUrl: './medicall-record-add.component.html',
  styleUrls: ['./medicall-record-add.component.scss']
})
export class MedicallRecordAddComponent implements OnInit {
  patient: IPatient;
  officeList = [];
